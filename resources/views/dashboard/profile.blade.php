            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <aside class="lg:col-span-4 space-y-6">
                    <div
                        ...
                        <div id="upload-box" class="relative group cursor-pointer mb-6">
                            <div
                                class="w-32 h-32 rounded-full overflow-hidden border-4 border-surface ring-4 ring-primary/20">
                                @if (auth()->user()->image)
                                    <img id="profileImagePreview" alt="Profile" class="w-full h-full object-cover"
                                        src="{{ asset('storage/' . optional(auth()->user()->image)->path) }}" />
                                @else
                                    <img alt="Profile" id="profileImagePreview" class="w-full h-full object-cover"
                            ...
                            <div
                                ...
                                <input type="file" id="profileImageInput" name="image" class="hidden" accept="image/*">
