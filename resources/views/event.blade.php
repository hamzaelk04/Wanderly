                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="mt-6 flex gap-3">
                            <a href="{{ route('event.detail', $event->id) }}"
                                class="flex flex-1 justify-center items-center py-4 rounded-xl bg-surface-container-low text-primary font-bold hover:bg-surface-container-high transition-all duration-300">
                                View Details
                            </a>
                            <button
