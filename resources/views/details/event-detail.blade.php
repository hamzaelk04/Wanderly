          ...
          <div class="flex justify-between items-center">
            <div>
              ...
              <div class="flex items-baseline gap-1">
                <span class="text-3xl font-extrabold text-on-background font-headline">€18.50</span>
          ...
          <div class="space-y-4">
            <div class="p-4 bg-surface rounded-xl border border-outline-variant/30 flex justify-between items-center">
              <div class="flex flex-col">
                ...
                <span class="font-semibold">Adult (18+)</span>
              </div>
              <div class="flex items-center gap-4">
                <button
                  class="w-8 h-8 rounded-full border border-outline-variant flex items-center justify-center hover:bg-surface-variant transition-colors">-</button>
