        ...
        <div class="grid lg:grid-cols-2 max-w-6xl w-full bg-surface-container-lowest rounded-3xl overflow-hidden shadow-2xl shadow-on-surface/5">
            <div class="relative hidden lg:block overflow-hidden">
                ...
                <div class="absolute bottom-12 left-12 right-12 text-white">
                    <h1 class="text-4xl font-extrabold font-headline mb-4 leading-tight tracking-tight">Commencez votre aventure organisée.</h1>
                    <p class="text-lg opacity-90 font-medium">Rejoignez une communauté d’explorateurs et de conservateurs culturels.
                ...
                <form id="regsiter_form" class="space-y-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input class="w-full px-5 py-4 bg-surface-container rounded-xl border-none focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline-variant"
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-semibold font-label text-on-surface-variant ml-1" for="email">Adresse E-mail</label>
                        <input
                            class="w-full px-5 py-4 bg-surface-container rounded-xl border-none focus:ring-2 focus:ring-primary/20 transition-all placeholder:text-outline-variant"
                    ...
                    <div
                        ...
                        <div class="ml-4 text-sm leading-6">
                            <label class="font-bold text-on-surface cursor-pointer select-none" for="organizer">Je veux m’inscrire en tant qu’organisateur d’événements</label>
                            <p class="text-on-surface-variant text-xs mt-1">Host bespoke tours, cultural workshops, or
                                Aventures Organisées.</p>
                        </div>
                    </div>
                    <div class="pt-4">
                        <button class="w-full adventure-gradient text-white py-4 rounded-full font-bold text-lg shadow-lg shadow-primary/20 transition-all hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
                            type="submit">
