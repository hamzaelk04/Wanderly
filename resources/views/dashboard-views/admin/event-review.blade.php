                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div
                                class="group flex items-start justify-between p-4 rounded-2xl hover:bg-surface-container-low transition-colors">
                                <div>
                                    <p class="text-[10px] font-bold text-outline uppercase tracking-widest mb-1">Capacity
                                    </p>
                                    <input
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div
                                class="group flex items-start justify-between p-4 rounded-2xl hover:bg-surface-container-low transition-colors">
                                <div>
                                    <p class="text-[10px] font-bold text-outline uppercase tracking-widest mb-1">Duration
                                    </p>
                                    <input
                                        class="w-full bg-transparent border-none p-0 font-semibold text-on-surface focus:ring-0"
